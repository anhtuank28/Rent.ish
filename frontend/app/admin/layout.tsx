...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-surface flex">
      {/* Sidebar */}
      <aside className="w-64 bg-surface-container-lowest border-r border-surface-container-low flex flex-col fixed inset-y-0 left-0 z-30">
        {/* Logo & Admin Badge */}
        <div className="p-6 border-b border-surface-container-low flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2">
            <Image src="/logo.png" alt="Rent-ish" width={110} height={26} className="h-6 w-auto object-contain" />
          </Link>
        ...
        <div className="p-4 border-t border-surface-container-low bg-surface-container-low/30">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              title="Đăng xuất"
              className="p-1.5 text-secondary hover:text-error hover:bg-error-container/20 rounded-lg transition-colors shrink-0"
            >
      ...
      <div className="flex-1 ml-64 flex flex-col min-h-screen">
        {/* Top Header */}
        <header className="h-16 bg-surface-container-lowest/80 backdrop-blur-md border-b border-surface-container-low sticky top-0 z-20 px-8 flex items-center justify-between">
