      ...
      <div className="w-full max-w-md bg-surface-container-lowest rounded-xl shadow-[0_20px_50px_-12px_rgba(36,30,26,0.08),0_2px_8px_0_rgba(36,30,26,0.03)] overflow-hidden p-6 sm:p-10">
        ...
        <div className="w-full animate-in fade-in">
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="space-y-1.5">
              <label className="block font-label-md text-label-md text-on-surface" htmlFor="signin-password">
                Mật khẩu
              </label>
              <div className="relative flex items-center">
            ...
            <div className="flex items-center justify-between pt-1">
              <label className="flex items-center gap-2.5 cursor-pointer select-none">
                ...
                <span className="font-body-sm text-body-sm text-secondary">Ghi nhớ đăng nhập</span>
              </label>
              <Link className="font-label-md text-label-md text-tertiary hover:underline" href="#">
                Quên mật khẩu?
              </Link>
            </div>
